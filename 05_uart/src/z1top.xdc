...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { busy }]; #IO_L6N_T0_VREF_34 Sch=led[0]
...
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { data_ready }]; #IO_L4P_T0_35 Sch=btn[0]
...
# UART on Pmod A
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { UART_TX }]; #IO_L17N_T2_34 Sch=ja_n[1]
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { UART_RX }]; #IO_L7P_T1_34 Sch=ja_p[2]
