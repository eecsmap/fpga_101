...
# use switch as button to make bouncing easier
# set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { BUTTONS[0] }]; #IO_L7N_T1_AD2N_35 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { status_led[0] }];
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { status_led[1] }];